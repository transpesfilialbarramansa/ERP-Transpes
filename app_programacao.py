...
with st.sidebar:
    # Cabeçalho da Sidebar (Logo em Branco com Fundo Transparente)
    if logo_base64_sidebar:
        st.markdown(f"""
            <div style="text-align: center; padding-bottom: 12px; margin-bottom: 18px; border-bottom: 1px solid rgba(255,255,255,0.08);">
                <img src="data:image/jpeg;base64,{logo_base64_sidebar}" style="max-width: 140px; height: auto; display: block; margin: 0 auto 6px auto; filter: brightness(0) invert(1);">
