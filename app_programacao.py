...
SVG_ICONS = {
    ...
    "user": '<svg style="vertical-align: middle; margin-right: 10px;" width="36" height="36" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="10" stroke="#D99B26" stroke-width="2" fill="none"/><path d="M12 11C13.6569 11 15 9.65685 15 8C15 6.34315 13.6569 5 12 5C10.3431 5 9 6.34315 9 8C9 9.65685 10.3431 11 12 11Z" fill="#D99B26"/><path d="M18 17.5C18 15.5 15.3333 14 12 14C8.66667 14 6 15.5 6 17.5" stroke="#D99B26" stroke-width="2" stroke-linecap="round"/></svg>',
